...
#----- Load NMFS & NEAMAP Survey Data -------------------------------------------------

surveydata <- read.csv("/Users/janellemorano/DATA/Atlantic_menhaden_modeling/current without chlorophyll/combined-catch-envtl.csv", header = TRUE)
