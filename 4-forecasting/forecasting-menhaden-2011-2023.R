...
# Create training (historic) data, 1972-2010
historic.sp <- data.list[[1]] %>%
  filter(Year >=1972 & Year <= 2010) %>%
  arrange(Year)
...
# Create future data for predictions, 2011-2023
#-- Forecast Spring
future.spring <- data.frame()
for (i in seq(2011, 2023)) {
...
# saveRDS(forecasting.data.list, file = "/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/forecasting.data.list.rds")

# forecasting.data.list <- readRDS("/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/forecasting.data.list.rds")




###########################################################################################
#----- GAM model fit to historic (1972-2010) data --------------------------------------------------
###########################################################################################
...
###########################################################################################
#----- Forecasting predictions, 2011-2023 ----------------------------------------------
###########################################################################################
...
print(combined_plot)
#ggsave(file = "/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/fig-forecast-GAM-bystate-2011-2023.png", width=7, height = 9)
...
#ggsave(file = "/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/fig-stateprop-2010-2023.png", width=7, height = 4)
