...
# Create training (historic) data, 1972-2020
...
###########################################################################################
#----- GAM model fit to historic (1972-2020) data --------------------------------------------------
###########################################################################################
...
saveRDS(historic.gam.list, file = "/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/historic-GAM-results-2021-2023.rds")
saveRDS(historic.gam.summaries, file = "/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/historic-GAM-summaries-2021-2023.rds")

pa.gam.list <- readRDS("/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/historic-GAM-results-2021-2023.rds")
pa.gam.summaries <- readRDS("/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/historic-GAM-summaries-2021-2023.rds")
...
print(combined_plot)
#ggsave(file = "/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/fig-forecast-GAM-bystate-2021-2023.png", width=7, height = 9)
...
#ggsave(file = "/Users/janellemorano/Git/AtlanticMenhaden/4-forecasting/fig-stateprop-2021-2023.png", width=7, height = 4)
