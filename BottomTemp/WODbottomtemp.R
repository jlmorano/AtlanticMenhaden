...
#High resolution CTD/XCTD (CTD) from 1 Jan 2007 to 31 Dec 2019

# Approximately the mouth of the Chesapeake (ocldb1635125177.4782_CTD.nc)
# Western edge = -76.237793 
# Eastern edge = -72.897949
# Northern edge = 37.847900
# Southern edge = 35.914307 

# Approximately NY Bight latitude (ocldb1635126367.19514_CTD.nc)
# Western edge = -74.5 
# Eastern edge = -67
# Northern edge = 41.5
# Southern edge = 40 
...
file1<-("ocldb1635125177.4782_CTD.nc")#Chesapeake straight from WODselect download site
file2<-("ocldb1635126367.19514_CTD.nc")#NYBight straight from WODselect download site
...
# Write to disk
write.csv(ddd_con1,"WOD_CTD_format_D50_2007-2019_Chesapeake.csv")
write.csv(ddd_con2,"WOD_CTD_format_D50_2007-2019_NYBight.csv")
