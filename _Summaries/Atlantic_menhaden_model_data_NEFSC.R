...
######################################
# Janelle L. Morano
# Compile data from NEFSC (Survdat from Kevin Friedland) and NEAMAP into: 
#   - sample data
#   - covariate data
...
# NEFSC data
#############
# These are NEFSC bottom trawl data that Kevin Friedland cleaned and shared. Menhaden positive counts are pulled out and saved with covariates AND adds ALL SAMPLE LOCATIONS so there are zero counts for menhaden.
# These data really need to be revised to come from the original data and/or I need more info about how these were compiled
NEFSC <- read.csv("/Users/janellemorano/DATA/Atlantic_menhaden_modeling/survdat.menhaden.csv", header = TRUE)
colnames(NEFSC)
# [1] "X"           "CRUISE6"     "STATION"     "STRATUM"     "TOW"         "SVSPP"       "CATCHSEX"   
# [8] "SVVESSEL"    "YEAR"        "SEASON"      "LAT"         "LON"         "EST_TOWDATE" "DEPTH"      
# [15] "SURFTEMP"    "SURFSALIN"   "BOTTEMP"     "BOTSALIN"    "ABUNDANCE"   "BIOMASS"     "LENGTH"     
# [22] "NUMLEN"      "species"    
