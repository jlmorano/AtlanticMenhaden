### Create_menhaden_test_data.R
### This creates test data for initial VAST model building and exploration using NEFSC bottom trawl data that Kevin Friedland cleaned and shared. Menhaden positive counts are pulled out and saved with covariates.
