...
![**(#fig:knots) Area the abundance is being predicted over and the number of knots used to calculate over the surface.**](/Users/janellemorano/Git/AtlanticMenhaden/docs/images/Data_and_knots.png){width=50%}
